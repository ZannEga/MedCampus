...
(function () {
    ...
    const PROFILE_HREF = IS_DOCTOR ? "/doctor/profile" : "/patient/profile";
    const LOGIN_HREF = IS_DOCTOR ? "/login?role=doctor" : "/login";
